<template>
  <div
    class="sticky bottom-0 bg-warnaHeading border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8 md:mx-auto mx-10"
  >
    <div class="flex items-center space-x-4">
      ...
      <div class="min-w-0 flex-auto space-y-1 font-semibold">
        <p class="text-[#171618] text-lg text-start">Full Stack Radio</p>
      </div>
    </div>
    <div class="space-y-2">
      <div class="relative">
      ...
      >
        <div class="text-[#171618]">24:16</div>
        <div class="text-[#171618]">75:50</div>
      </div>
    </div>
  </div>
  <div
  ...
  >
    ...
    >
      <!-- pause tombol -->
      <svg v-if="playMusic" width="30" height="32" fill="currentColor">
    ...
    <div class="flex-auto flex items-center justify-evenly">
      ...
      <button class="hidden sm:block lg:hidden xl:block">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
