<template>
  <div v-motion-fade class="">
    ...
    <h6 class="text-warnaHeading md:text-xl">
      <span class="p-2"></span>
    </h6>
    ...
    <div class="py-6 w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
      <div class=" grid grid-rows-3 grid-flow-col gap-2">
        ...
        >
          <span class="float-start font-medium p-4 text-2xl">
            Web Developer
          </span>
          <div class="absolute z-30 top-10 rounded-lg">
            <TestiList2 konten="VS Code" />
            <TestiList2 konten="Git" />
            <TestiList2 konten="Terminal" />
          </div>
          <img
            class="top-20 -right-10 z-10 absolute shadow-lg rounded-lg w-64"
            src="~/public/koding.jpg"
            alt=""
          />
        </div>
          ...
          >
            <div class="flex justify-around gap-2">
              ...
              <TechLg>
                <img
                  class="w-10"
                  src="https://laracasts.com/images/topics/icons/livewire-logo.svg?v=2"
                  alt=""
                />
              </TechLg>
              <TechLg>
                <img
                  class="w-10 mt-3"
                  src="https://laracasts.com/images/topics/icons/alpine-logo.svg?v=2"
                  alt=""
                />
              </TechLg>
              <TechLg>
                <img
                  class="w-10"
                  src="https://laracasts.com/images/topics/icons/tailwind-logo.svg?v=2"
                  alt=""
                />
              </TechLg>
              <TechLg>
                <img
                  class="w-10"
                  src="https://laracasts.com/images/topics/icons/vue-logo.svg?v=2"
                  alt=""
                />
              </TechLg>
              <TechLg>
                <img
                  class="w-10"
                  src="https://laracasts.com/images/topics/icons/sql-logo.svg?v=2"
                  alt=""
                />
              </TechLg>
            </div>
      ...
      <div class="grid grid-cols-3 grid-flow-col gap-2 py-2">
        <div class="col-span-2 bg-red-400 rounded-3xl z-10 relative overflow-hidden h-64">
          ...
          <img
            ...
            alt=""
          />
          <TestiList2 class="ml-48" v-for="item in tools" stroke="#1F2937" bg="bg-rose-100" :konten="item" />
        </div>
